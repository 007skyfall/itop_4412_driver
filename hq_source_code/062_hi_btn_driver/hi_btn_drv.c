...
struct key_desc keys_desc[] = {     //定义一个结构体数组
	{GPIO02_7_MUX_CTRL_REG_OFFSET, 0x00, GPIO02_BASE, IRQ_GPIO02_7, 0x00, 7, 0,  "KEY_0" },
	{GPIO01_1_MUX_CTRL_REG_OFFSET, 0x00, GPIO01_BASE, IRQ_GPIO01_1, 0x01, 1, 1,  "KEY_1" },
	{GPIO02_3_MUX_CTRL_REG_OFFSET, 0x00, GPIO02_BASE, IRQ_GPIO02_3, 0x02, 3, 2,  "KEY_2" },
	{GPIO02_4_MUX_CTRL_REG_OFFSET, 0x00, GPIO02_BASE, IRQ_GPIO02_4, 0x03, 4, 3,  "KEY_3" },
	{GPIO11_0_MUX_CTRL_REG_OFFSET, 0x00, GPIO11_BASE, IRQ_GPIO11_0, 0x04, 0, 4,  "KEY_4" },
	{GPIO11_4_MUX_CTRL_REG_OFFSET, 0x00, GPIO11_BASE, IRQ_GPIO11_4, 0x05, 4, 5,  "KEY_5" },
	{GPIO11_7_MUX_CTRL_REG_OFFSET, 0x00, GPIO11_BASE, IRQ_GPIO11_7, 0x06, 7, 6,  "KEY_6" },
	{GPIO01_2_MUX_CTRL_REG_OFFSET, 0x00, GPIO01_BASE, IRQ_GPIO01_2, 0x07, 2, 7,  "KEY_7" },
	{GPIO09_2_MUX_CTRL_REG_OFFSET, 0x00, GPIO09_BASE, IRQ_GPIO09_2, 0x08, 2, 8,  "KEY_8" },
	{GPIO09_4_MUX_CTRL_REG_OFFSET, 0x00, GPIO09_BASE, IRQ_GPIO09_4, 0x09, 4, 9,  "KEY_9" }
};
